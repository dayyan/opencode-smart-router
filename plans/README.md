...
| 045  | Make fanout workers true depth-2 children | P1 | M | MED | 044 | DONE (strict TDD on `advisor/045-fanout-tree`; live depth-2 probe PASS: caller-parented workers, no depth 3) |
